...
(async () => {
    // Launch a small CPU-only pod to download models to the network volume
    // We'll use a lightweight Python image to run wget/curl
    ...
    console.log("Starting model download pod...");
